...
- **Phase 0 doc prerequisites (P1.5, P1.7, P1.9, and the P1.3 Azure-client subset) are resolved** — see `to_resolve.md` Resolved decisions. Brokers, shared Azure clients, locale enum/mapping, and guild Patch/soft-delete helpers are implementation-ready; leftover P1.3/P1.1/P1.2/P1.4/P1.6/P1.8 remain intentionally deferred.
