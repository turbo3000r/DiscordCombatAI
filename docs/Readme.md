...
- **Phase 3 documentation gate is closed** — ProcessCommand, `/config`, `/suggest`, Queue/sweep/DM delivery, minimal Web Suggestions slice, and S12 are specified in `to_resolve.md` → Phase 3. Still deferred: offline guild-removal sweep, P1.1–P1.2, remaining P1.6 Web polish, `/quick-battle`, non-Suggestions Web pages, webhook/S13.
